...
export default async function NotesPage({
  ...
  return (
    <main className="min-h-screen px-3 py-3 text-stone-950 sm:px-4 sm:py-4 lg:px-5">
      <div className="mx-auto flex max-w-[1600px] flex-col gap-3">
        <header className="overflow-hidden rounded-xl border border-white/60 bg-white/70 shadow-[0_18px_50px_rgba(23,23,23,0.08)] backdrop-blur">
          <div className="flex flex-col gap-4 px-5 py-4 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-stone-200 bg-white/80 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-stone-500">
              ...
              <p className="mt-2 max-w-md text-sm leading-6 text-stone-600 sm:text-base">
        ...
        <section className="grid gap-3 lg:grid-cols-[220px_minmax(320px,460px)_minmax(0,1fr)]">
          <aside className="rounded-xl border border-stone-200 bg-white/75 p-4 shadow-[0_18px_50px_rgba(23,23,23,0.08)] backdrop-blur">
            <div className="mb-4 flex items-center justify-between">
              <div>
                <p className="text-[11px] uppercase tracking-[0.18em] text-stone-400">
                  Library
                </p>
                <p className="mt-1 text-sm font-semibold text-stone-950">Notebooks</p>
              </div>
                  ...
                  <Link
                    ...
                    className={[
                      ...
                      active
                        ...
                        : "border-stone-200 bg-white/80 text-stone-700 hover:-translate-y-0.5 hover:border-stone-300 hover:bg-white hover:shadow-sm",
                    ].join(" ")}
                  >
                    <span>
            ...
            <div className="mt-4 rounded-md border border-stone-200 bg-stone-50 p-3 text-sm text-stone-600">
              <p className="text-[11px] uppercase tracking-[0.18em] text-stone-400">Latest</p>
          ...
          <section className="overflow-hidden rounded-xl border border-stone-200 bg-white/80 shadow-[0_18px_50px_rgba(23,23,23,0.08)] backdrop-blur">
            ...
            <ul className="max-h-[calc(100vh-190px)] divide-y divide-stone-200 overflow-auto">
              ...
              {filteredRows.length === 0 ? (
                <li className="px-4 py-10 text-sm text-stone-600">
          ...
          <aside className="overflow-hidden rounded-xl border border-stone-200 bg-white/80 shadow-[0_18px_50px_rgba(23,23,23,0.08)] backdrop-blur">
            {selectedRow ? (
              ...
              <div className="flex h-full min-h-[420px] items-center justify-center px-6 text-center text-stone-600">
                <div>
                  <p className="text-[11px] uppercase tracking-[0.18em] text-stone-400">
                    Preview
                  </p>
